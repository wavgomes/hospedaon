...
class QuartosControllerTest < ActionController::TestCase
  ...
  test "should create quarto" do
    assert_difference('Quarto.count') do
      post :create, quarto: { descricao: @quarto.descricao, nome: @quarto.nome, telefone: @quarto.telefone, valor: @quarto.valor }
    end
  ...
  test "should update quarto" do
    patch :update, id: @quarto, quarto: { descricao: @quarto.descricao, nome: @quarto.nome, telefone: @quarto.telefone, valor: @quarto.valor }
    assert_redirected_to quarto_path(assigns(:quarto))
  end
